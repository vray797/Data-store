...
create("rohit",70,3600) 
#to create a key with key_name,value given and with time-to-live property value given(number of seconds read("maha")
...
t1=threading.Thread(target=(create or read or delete),args=("abhi",50,3600)) #as per the operation
t1.start()
time.sleep(3)
print("Thread_1 executed")

t2=threading.Thread(target=(create or read or delete),args=("danish",200)) #as per the operation
t2.start()
time.sleep(1)
print("Thread_2 executed")

t3=Thread(target=(create or read or delete),args=("abhi",400,400))#as per the operation
t3.start()
time.sleep(2)
